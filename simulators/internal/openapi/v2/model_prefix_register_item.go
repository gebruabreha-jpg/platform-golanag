...
type PrefixRegisterItem struct {
	...
	LookupType *PrefixRegisterItemLookupType `json:"lookupType,omitempty"`
	NexthopType *PrefixNexthopType `json:"nexthopType,omitempty"`
}
...
func (o *PrefixRegisterItem) GetLookupType() PrefixRegisterItemLookupType {
	if o == nil || IsNil(o.LookupType) {
		var ret PrefixRegisterItemLookupType
		return ret
	}
	return *o.LookupType
}
...
// SetLookupType gets a reference to the given PrefixRegisterItemLookupType and assigns it to the LookupType field.
...
// SetNexthopType gets a reference to the given PrefixNexthopType and assigns it to the NexthopType field.
